...
![Cursor AI](https://img.shields.io/badge/Cursor%20AI-000000?style=flat)
...
A secure, full-stack application with JWT authentication and role-based access control.
...
### 🎓 SmartLearner
An education platform built to deliver an interactive learning experience.

**Tech:** Java • Spring Boot • React.js • MySQL

- ⚙️ **RESTful backend services** built with Spring Boot
...
- **B.E. in Computer Science Engineering** — Rajiv Gandhi College of Engineering and Research, Nagpur (2019–2023)
- NASSCOM Certified Java Web Developer
- Full Stack Java — Naresh IT
- DSA & Java Mastery — Infosys Lex
- Cursor AI 101 — Infosys Wingspan
